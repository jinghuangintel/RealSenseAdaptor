...
*/
#ifndef __REALSENSE_PROP_GET_LISTENER_HEADER__
#define __REALSENSE_PROP_GET_LISTENER_HEADER__

#include "mwadaptorimaq.h" 
#include "RealSenseAdaptor.h" // For this example

class RealsensePropGetListener : public imaqkit::IPropCustomGetFcn
{
public:

	// Constructor/Destructor
	RealsensePropGetListener(RealSenseAdaptor* parent) :
		_parent(parent) {};

	virtual ~RealsensePropGetListener(void) {};
